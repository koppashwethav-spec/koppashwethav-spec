...
<p align="center">
  ...
  <a href="https://github.com/koppashwethav-spec?tab=achievements">
...
public class ShwethaV {
    ...
    String degree      = "B.E. AI & ML — BGS Institute of Technology (CGPA: 8.35)";
    String role        = "Java Full Stack Developer";

    String[] skills    = {"Java", "Spring Boot", "REST API", "PostgreSQL", "HTML/CSS/JS"};
    String[] interests = {"Backend Development", "System Design", "Machine Learning"};
...
<table>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <a href="https://shopkart-etg6.onrender.com" target="_blank">
          <img src="https://img.shields.io/badge/🌐_Live_Demo-46E3B7?style=for-the-badge"/>
        </a>
        <a href="https://github.com/koppashwethav-spec/shopkart" target="_blank">
          <img src="https://img.shields.io/badge/GitHub-171515?style=for-the-badge&logo=github"/>
        </a>
      </p>
      <p align="center">Flipkart-style full-stack e-commerce app with REST APIs for products, orders, users & reviews. Deployed live on Render.com.</p>
      <p align="center">
    ...
    <td width="50%">
      <h3 align="center">🔐 Cyber Breach Detection</h3>
      <p align="center">
        <img src="https://img.shields.io/badge/📄_Research_Published-FF6B6B?style=for-the-badge"/>
      </p>
      <p align="center">ML system to predict & detect cybersecurity breaches using pattern recognition on historical data. Research paper accepted at AIT, Tumkur.</p>
      <p align="center">
  ...
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <a href="https://github.com/koppashwethav-spec/expense-tracker" target="_blank">
          <img src="https://img.shields.io/badge/GitHub-171515?style=for-the-badge&logo=github"/>
        </a>
      </p>
      <p align="center">Java Full Stack Student Expense Tracker System with clean UI and backend logic.</p>
      <p align="center">
        <img src="https://img.shields.io/badge/Java-ED8B00?style=flat&logo=openjdk&logoColor=white"/>
